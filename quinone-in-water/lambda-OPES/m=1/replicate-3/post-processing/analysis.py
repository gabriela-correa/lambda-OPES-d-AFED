...
np.savez("deltaF_bias.npz", bias_conv = (k_output / k_input) * data2["opes_conv_bias (kJ/mol)"], bias_expl = (k_output / k_input) * data2["opes_expl_bias (kJ/mol)"], lam = data['lbda'], time= data['time'])
...
np.savez("deltaF_lambda.npz", deltaF = deltaFij[-1,:], lam = labels_full)
